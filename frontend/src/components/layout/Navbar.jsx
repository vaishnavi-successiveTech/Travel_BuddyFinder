...
//             <img src="/image/logo.png" alt="Logo" className="h-8 w-8 rounded-full object-cover" />
...
//               {/* Dropdown */}
//               {showDropdown && (
//                 <div className="absolute right-0 mt-2 w-80 bg-white text-black rounded-lg shadow-lg max-h-80 overflow-y-auto z-50 scrollbar-thin scrollbar-thumb-transparent scrollbar-track-transparent">
...
// const Navbar = () => {
//   const router = useRouter();
//   const { user, setUser, logout } = useAuth(); // assuming your AuthContext has `user`
